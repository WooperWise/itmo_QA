...
class DatabaseMigrator:
    ...
    def verify_migration(self) -> bool:
        ...
        try:
            ...
            current_version = self.get_current_version()
            if current_version != self.current_schema_version:
                logger.error(f"Schema version mismatch after migration: expected {self.current_schema_version}, got {current_version}")
                return False
    ...
    def get_migration_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'pending_migrations': [v for v in self.migrations.keys() if v > current_version],
